...
class details  implements ActionListener{
    ...
    JFrame f;
    JLabel l1,l2;//Frame photo, Employee details lable
    JButton b1,b2,b3,b4;//Add, remove, update, View 
    ...
    public void actionPerformed(ActionEvent ae){/*ActionEvent class will differentiate with Action listener to perform the option by selecting proper button*/
        if(ae.getSource()==b1){
            f.setVisible(false);
            new Add_Employee();
        }
